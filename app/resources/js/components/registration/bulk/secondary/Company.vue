<template>
    <div class="col-8">
        ...
        <form id="bulkRegSaveForm" @submit.prevent="submit" class="mb-3 p-3">
            ...
            <div class="form-row mb-3" v-show="showTINBlock">
                <div class="col-4">
                    <label class="text-bold" for="exampleInputEmail1"
            ...
            <div class="form-row mb-3" v-show="showLicenceBlock">
                <div class="col-6">
                    <label class="text-bold" for="exampleInputEmail1"
            ...
            <div class="form-row mb-3" v-show="showIncorporationCertBlock">
                <div class="col-4">
                    <label class="text-bold" for="exampleInputEmail1"
            ...
            <div class="form-row mb-3" v-if="showRegistrationCertBlock">
                <div class="col-4">
                    <label class="text-bold" for="exampleInputEmail1"
                        >Certificate of Incorporation (BRELA)</label
                    >
...
export default {
    ...
    data() {
        return {
            ...
            showIncorporationCertBlock: false,
            showRegistrationCertBlock: false,
            showLicenceBlock: false,
            categories: [
                {
                    ID: "COMP_I",
                    Description: "Company SIM (Incorporation Certificate)"
                },
                {
                    ID: "COMP_R",
                    Description: "Company SIM (Registration Certificate)"
                },
                {
                    ID: "INST",
    ...
    methods: {
        submit() {
            ...
            axios
                .post("/api/one-sim/bulk/secondary-register", formData, {
                    headers: {
        ...
        onRegistrationCategoryChange(event) {
            ...
            if (event.target.value == "COMP_I") {
                this.showSPOCAttachment = false;
                this.showTINBlock = true;
                this.showLicenceBlock = true;
                this.showIncorporationCertBlock = true;
                this.showRegistrationCertBlock = false;
            } else if (event.target.value == "COMP_R") {
                this.showSPOCAttachment = false;
                this.showLicenceBlock = true;
                this.showRegistrationCertBlock = true;
                this.showIncorporationCertBlock = false;
                this.showTINBlock = true;
