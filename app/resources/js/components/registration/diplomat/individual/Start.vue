                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter diplomat passport number"
                                    />
                                    <div
    ...
    methods: {
        submit() {
            ...
            if (this.loaded) {
                ...
                axios
                    .post("/api/diplomat/check-msisdn", this.fields)
                    .then(res => {
                        loader.hide();

                        if (res.data.status === 2) {
                            window.location =
                                "/one-sim/diplomat/register-primary";
                        } else if (res.data.status === 1) {
                            window.location =
                                "/one-sim/diplomat/register-secondary";
                        }
