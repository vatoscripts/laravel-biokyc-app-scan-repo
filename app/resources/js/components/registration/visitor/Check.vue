                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input
                                        ...
                                        placeholder="Enter visitor passport number"
                                    />
                                    <div
                                        v-if="errors && errors.passportNumber"
                                        class="text-danger"
                                    >
    ...
    methods: {
        submit() {
            ...
            if (this.loaded) {
                ...
                axios
                    .post("/api/visitor/check-msisdn", this.fields)
                    .then(res => {
                        loader.hide();
                        ...
                        if (res.data.status === 2) {
                            window.location = "/one-sim/visitor/primary";
                        } else if (res.data.status === 1) {
                            window.location = "/one-sim/visitor/secondary";
                        }
                    })
                    .catch(error => {
                        this.loaded = true;
