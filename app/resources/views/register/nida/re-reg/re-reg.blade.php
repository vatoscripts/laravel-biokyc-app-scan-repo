    ...
    <section class="section-container">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-heading">
                <div>Customer Re-registration
                    <p class="lead mt-2">KYC Detail</p>
                </div>
            </div>
...
@include('register.nida.re-reg.reReg-modal')
@include('register.nida.defaced-qn')
...
<script src="{{ asset('js/defaced.js') }}"></script>
<script src="{{ asset('js/kyc-re-reg.js') }}"></script>
